...
public class FileHandler {
    ...
    //     try {
    //         BufferedWriter bw = new BufferedWriter(new FileWriter(defaultDataFilePath + filename, true));
    //             for(int i = 0; i < data.size(); i++){
    //                 if(i != data.size() - 1){
    //                     bw.write(data.get(i) + separator);
    //                 } else{
    //                     bw.write(data.get(i) + "\n");
    //                 }
    //             }
    ...
    //     } catch (IOException e) {
    //         System.err.println("Error writing to file: " + defaultDataFilePath + filename);
    //         e.printStackTrace();
    //     }
    // }
